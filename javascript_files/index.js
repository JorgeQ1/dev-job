...
function listJobs(){
    data.forEach((card)=>{
        content.innerHTML += `
            <div onclick="saveJob(${card.id})" class="parent-card">
                <a href="../html_fies/job_details.html" target="_blank">
                <div class="card dark-theme">
                    <div class="job-logo">
                        <div class="job-logo-background" style="background-color: ${card.logoBackground}">
                            <img src="${card.logo}" alt="job-logo">
                        </div>
                    </div>
                    <div class="job-content">
                        <div class="time-posted">
                            <p>${card.postedAt} <span>.</span> <span>${card.contract}</span></p>
                        </div>
                        <div class="job-type">
...
function loadJob(){
    ...
    if(id){
        let card = data.find(cd=>cd.id==id)
        if(card){
            console.log(card)
            let image = document.getElementById("job-image")
            let imageBg = document.getElementById("job-image-background")
